...
<div align="center" style="font-family:'Times New Roman', Times, serif; margin-top:50px;">
  ...
  <div style="background: linear-gradient(90deg, #0B1E3F, #1A3A6B, #2F5BA0); padding: 20px; border-radius: 12px; margin-bottom: 30px; width: 100%; max-width: 800px; color: #FFFFFF;">
    <h2 style="font-size:24px; margin:0; text-align:center;">Every Ending Seeds a New Beginning</h2>
    <p style="font-size:15px; margin-top:12px; line-height:1.6; text-align:center;">
  ...
  <div style="background: linear-gradient(90deg, #2F0B3F, #6B1A6B, #A02F5B); padding: 20px; border-radius: 12px; width: 100%; max-width: 800px; color: #FFFFFF;">
    <h2 style="font-size:24px; margin:0; text-align:center;">You've Reached the Limits</h2>
    <p style="font-size:15px; margin-top:12px; line-height:1.6; text-align:center;">
